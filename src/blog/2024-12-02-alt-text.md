...
{% image "/images/alt-text-why.png", "Graphic mimicking an image that has failed to load, displaying a 'broken image' icon and faux alt text reading 'Why you should write alt text'" %}
...
{% image "/images/Scoteanax rueppellii 1.jpg", "" %}
{% endfigure %}
...
{% image "/images/stock-image-meeting.jpg", "" %}
{% endfigure %}
...
{% image "/images/moorgate-sign.jpg", "" %}
{% endfigure %}
...
{% image "/images/garfield-pipe-strip.gif", "" %}
{% endfigure %}
