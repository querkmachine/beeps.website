...
Following this, there was a period of a few years where I didn't operate a personal website, instead focusing my efforts on various projects aimed at the furry fandom.
...
It wouldn't be until 2010 that I started working on a new personal website, around the time I stopped using my birth name in earnest, my university years initially branded under the name "Furrified" (a domain originally picked up for, unsurprisingly, an unrealised furry fandom project), with the subtitle "Grey's Adventures in Web Design".
