...
{% callout %}
Update (2026-09-08): I've since given this thing a proper name and domain name: [Battenburg](//battenburg.app). The links in the post have been updated to point to the new domain name, though the original text remains unaltered.
{% endcallout %}
...
{% figure caption="Tadaaa! [Link to this grid.](https://battenburg.app/?hash=MDAwLDRCNEI0QixFRUUsRkZGLDU4ODE1NywwMEUyMDAsNzg2OTk5LDdDNTZGQyxGQzA%3D)" %}
...
The [Contrast Ratio Color Grid tool](https://battenburg.app/) (I never said I was good at names) is a side project that I started working on in 2024, when I first got involved in the [GOV.UK brand refresh project]({{ '/blog/2025-06-25-the-not-quite-new-govuk-brand/' | url }}).
...
So uh, check it out I guess. Here's [an example with a buttload of colours](https://battenburg.app/?hash=) to serve as a demonstration of how useful it can be.
...
[Of course it is, you silly goose.](https://github.com/querkmachine/battenburg.app) It's permissively licensed too. Do whatever the hell you want with it.
