...
title: In 2025
date: 2025-12-20
tags: [yearly theme, transition, medical, furry fandom]
metadata:
...
{% youtube "tKolNVrRKfs", { title: "I Don't Wanna Talk music video" } %}

["Ice Water"](https://song.link/gb/i/1819126790) is the first track on _Lonely Magic_, the second album by _Steven Universe_ creator (and major _Adventure Time_ contributor) Rebecca Sugar. A powerfully upbeat, autobiographical track about being in love and pursuing creative passion. It's a wonderful companion to ["Hill to Die On"](https://song.link/y/pYS9WjAjfro) from later in the album, which speaks about the cost of success in those creative endeavours.

{% youtube "J77yQcT517E", { title: "Ice Water music video" } %}

Sugar's album ends on ["This is a Love Song"](https://song.link/y/G9nUIpRZvc8), an unrestrained, angry tune about escaping an unhealthy relationship. In that same vein, another song I've really vibed with this year is ["talking shit"](https://song.link/y/zrLzeogHaHM) by Montagne, from the album _it's hard to be a fish_.
...
{% youtube "zrLzeogHaHM", { title: "talking shit music video" } %}

This year, Pulp released _More_, their first studio album in 24 years. It's very like Pulp, which is to say that I like it on occasion, but it's not the kind of thing I want to have all of the time.
...
{% youtube "-27a1ugJX8U", { title: "Spike Island music video" } %}
...
Over the last year, [I've given about £1,850](https://social.beeps.gay/@beeps/115493165587843277) to various charities, non-profits, mutual aid organisations, and independent creators. That number's probably going to go up in 2026.
