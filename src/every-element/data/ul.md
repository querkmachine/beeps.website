...
Surrounds a list of [`li`](#li) where the order of the items is irrelevant, that is, where changing the order of the items wouldn't alter they're understood. For example, a shopping list or list of tasks.
